    ...
    <Box position="relative">
      ...
      <Box w="100%" bg="#26262e" color="white" py={12} px={6}>
        ...
        >
          {/* 📞 Phone Number */}
          <Flex align="center">
            <Icon as={FaPhoneAlt} color="pink.400" boxSize={5} mr={3} />
            <Box>
          ...
          {/* 📍 Location */}
          <Flex align="center">
            <Icon as={FaMapMarkerAlt} color="pink.400" boxSize={5} mr={3} />
            <Box>
          ...
          {/* ⏳ Hours */}
          <Flex align="center">
            <Icon as={FaClock} color="pink.400" boxSize={5} mr={3} />
            <Box>
      ...
      <Box id="contact" w="100%" bg="#26262e" color="white" py={16} px={6}>
        ...
        >
          ...
          {/* 📧 Email */}
          <Flex align="center">
            <Icon as={FaEnvelope} color="pink.400" boxSize={5} mr={3} />
            <Box>
